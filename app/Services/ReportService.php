...
final class ReportService
{
    ...
    public function reportForPeriod(int $restaurantId, string $date, string $period, array $viewFilters = []): array
    {
        ...
        $loadHeavyReport = !empty($viewFilters['__report_heavy']);
        if (isset($viewFilters['__report_heavy'])) {
            unset($viewFilters['__report_heavy']);
        }
        ...
        $summary['agents_activity'] = $loadHeavyReport
            ? $this->agentsActivityBreakdown($restaurantId, $startAt, $endAt, $viewFilters, $reportActivityIndex)
            : [
