...
final class RailwayDbTools
{
    ...
    public static function seedMinimal(array $config): array
    {
        ...
        try {
            ...
            foreach (['branding','reports','menu','pwa','stock','kitchen','sales','losses'] as $module) { self::upsertModule($pdo, $r1, $module, 1, $report); self::upsertModule($pdo, $r2, $module, 1, $report); }
            $pdo->commit();
        } catch (Throwable $e) {
