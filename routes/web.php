...
$router->get('/media/restaurants/{restaurantCode}/menu', [MediaController::class, 'menuUpload']);
$router->get('/media/restaurants/{restaurantCode}', [MediaController::class, 'restaurantUpload']);
...
$router->post('/super-admin/sandbox/run-midnight-e2e', [DashboardController::class, 'runSandboxMidnightE2e'], [AuthMiddleware::class, SuperAdminMiddleware::class]);
...
$router->post('/audit-externe/rapports/{id}/soumettre', [ExternalAuditController::class, 'submit'], [AuthMiddleware::class]);
$router->post('/audit-externe/rapports/{id}/reinitialiser', [ExternalAuditController::class, 'reset'], [AuthMiddleware::class]);
$router->get('/audit-externe/periode', [ExternalAuditController::class, 'period'], [AuthMiddleware::class]);
$router->get('/audit-externe/export/excel', [ExternalAuditController::class, 'excel'], [AuthMiddleware::class]);
$router->get('/audit-externe/export/pdf', [ExternalAuditController::class, 'pdf'], [AuthMiddleware::class]);
$router->post('/audit-externe/rapports/{id}/correction', [ExternalAuditController::class, 'requestCorrection'], [AuthMiddleware::class]);
$router->post('/audit-externe/corrections/{id}/decision', [ExternalAuditController::class, 'decideCorrection'], [AuthMiddleware::class]);
