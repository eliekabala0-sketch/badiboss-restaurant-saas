...
foreach (['external_audit_reports','external_audit_role_expectations','external_audit_report_items','external_audit_results','external_audit_losses','external_audit_confrontations','external_audit_exports'] as $table) {
...
echo "OK ExternalAuditSafety: 14 controles securite\n";
